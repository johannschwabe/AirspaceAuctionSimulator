...
simulation_config = generate_config(
    ...
    description='This model was generated u sing the 1_demo_howto.py Script',
...
with open('Prefabs/configs/1_report_demo_howto-config.json', 'w') as f:
    f.write(json.dumps(simulation_config))

with open('Prefabs/outputs/1_report_demo_howto-output.json', 'w') as f:
